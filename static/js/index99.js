$(function(){
    ...
    var musicImgsData = ['../static/img/bg.jpg','../static/img/bg1.jpg','../static/img/bg2.jpg']    // 图片地址数组
    ...
    function getMusicInfo(){
        for(let i = 0; i<musicList.length; i++){
            musicNameData.push(musicList[i]['musicName'])
            artistNameData.push(musicList[i]['singer'])
            musicUrls.push(musicList[i]['src'])
        }
    }
