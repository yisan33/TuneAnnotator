      ...
      <div v-for="(level, index) in getCurrentPageLevels()" :key="index">
        ...
        <div class="song-container">
          <div v-for="(song, songIndex) in level.songs" :key="songIndex" class="song-item">
            <p class="audio-description"><strong>{{ song.name }}</strong> : {{song.tip}}</p>
            <audio :ref="'audio' + songIndex" :key="song.artist + '-' + song.name" controls
            style="width: 300px; height: 35px; border-radius: 5px; margin-top: 10px">
            ...
            <el-form ref="form" label-width="70px" :inline="true" :model="form" :rules="rules"
                ...
                <div class="form-container">
                  <el-tooltip placement="left" effect="customized">
                    <div slot="content" style="font-size: 15px; width: 800px; max-width: 300px;">
                      ...
                      <br/><br/>打分细则：
                      <br/><br/>90-100分：
                      带给人的整体听感极好，营造的整体氛围以及艺术表现力极强；（技术完善，无瑕疵，有感染力，有独特性）
                      <br/><br/>80-89分：
                      带给人的整体听感较好，营造的整体氛围以及艺术表现力较强；（85以上需要有一定的独特性）
                      <br/><br/>70-79分： 
                      带给人的整体听感一般，营造的整体氛围以及艺术表现力一般；(有瑕疵70~74；无瑕疵75~79)
                      <br/><br/>60-69分：
                      带给人的整体听感较差，缺乏整体氛围以及艺术表现力；（缺陷比较多）
                      <br/><br/>59分以下： 
                      带给人的整体听感很差，音乐不知所云；（乱弹琴没法听）
                    </div>
              ...
              <el-form ref="form" label-width="70px" style="margin-top: 50px;" :inline="true"
                ...
                <div class="form-container">
                  <el-tooltip placement="left" effect="customized">
                    <div slot="content" style="font-size: 15px; width: 800px; max-width: 300px;">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;演唱是歌手通过对声音的运用，将歌曲中蕴含的内容及情感生动地传达给听众。评价演唱的主要子维度为：音色条件、音准及节奏、演唱技巧。
                      <br/>
                     （1）音色条件：旨在考察演唱者在一首歌曲中所展现出来的先天声音条件，这被认为是演唱表现的最基础条件之一。
                      <br/>（2）音准及节奏：旨在考察演唱者在演唱中的音准、节奏把握是否准确自然。音准、节奏也同样被认为是演唱表现的基础条件之一。
                      <br/> (3)演唱技巧：旨在考察演唱者在经过声乐技能训练后所展现出来的演唱能力，主要包括：发音吐字和声乐技巧（包括气息控制、腔体共鸣、声区统一、真假声转换、颤音、转音等）。
                      这些技巧的训练可以提高演唱者对声音的美化以及对歌曲的驾驭能力，使许多先天嗓音不理想的演唱者能够通过这一维度的加强，实现演唱水平的大幅提升。
                    
                      <br/><br/>打分细则：
                      <br/><br/>90-100分：音色悦耳；音准、节奏把握准确；吐字清晰自然；技巧发挥成熟；音色具有辨识度；演唱细腻有感染力；
                      <br/><br/>80-89分：音色悦耳；音准、节奏把握准确；吐字清晰自然；技巧发挥成熟；
                      <br/><br/>70-79分： 音色一般且部分技巧运用不够成熟；或个别音准、节奏把握不准确；或吐字不清晰、或吐字清晰但不自然；或大量多字缺字；
                      <br/><br/>60-69分：音色较差且整体技巧运用不成熟；或个别乐句音准、节奏把握不准确；
                      <br/><br/>59分以下： 音色差且没有声乐技巧；或1/3以上的音准、节奏把握不准确（基本没有音高、节奏感）
              ...
              <el-form ref="form" label-width="70px" style="margin-top: 50px;" :inline="true"
                ...
                <div class="form-container">
                  ...
                  <el-tooltip placement="left" effect="customized">
                    <div slot="content" style="font-size: 15px; width: 800px; max-width: 300px;">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;旋律是音乐的主要线索，它可以反映音乐结构，表达音乐情感，传达音乐主题。评价旋律的主要子维度为：完整性、流畅性、易记性以及独特性。
                      <br/>（1）完整性：旨在考察旋律是否完整，结构是否明确清晰，词曲搭配是否协调。
                      <br/>（2）流畅性：具有流畅性的旋律通常呈波浪形的曲线，较少出现突兀的音高变化；声区间连接顺畅；没有过多的装饰音；旋律通常保持在原调及其关系调内，即谨慎使用变化音；
                      <br/>（3）易记性：旨在考察旋律是否具有明显的记忆点；
                      <br/>（4）独特性：旨在考察旋律是否在设计上有一些独到之处，能够区别于其他歌曲的旋律

                      <br/><br/>打分细则：（在演唱者音高、节奏唱不准的情况下，不对其演唱的旋律进行任何推测，遵循所听即所得）
                      <br/><br/>90-100分：
                      整首歌曲旋律完整，结构清晰，词曲搭配协调；旋律流畅，极具美感；具有较强的易记性或独特性；有感染力；
                      <br/><br/>80-89分：
                      整首歌曲旋律完整，结构清晰，词曲搭配协调；旋律流畅，具有美感；具有一定的易记性或独特性；
                      <br/><br/>70-79分： 
                      整首歌曲旋律完整，结构清晰，词曲搭配协调；旋律流畅，略有美感；具有一定的易记性；不具有独特性；
                      <br/><br/>60-69分：
                      整首歌曲旋律完整，结构比较清晰，词曲搭配比较协调；但缺乏流畅性，不具有美感；
                      <br/><br/>59分以下： 
                      整首歌曲旋律不完整，或结构混乱，或词曲搭配不协调；或缺乏流畅性，缺乏美感；
                    </div>
              ...
              <el-form ref="form" label-width="70px" style="margin-top: 50px;" :inline="true"
                ...
                <div class="form-container">
                  <el-tooltip placement="left" effect="customized">
                    <div slot="content" style="font-size: 15px; width: 800px; max-width: 300px;">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;编曲是指对音乐作品中各种乐器、声音元素和音符进行有序安排和组合的过程。编曲的质量取决于其能否巧妙地运用不同乐器与声音元素，以创造出丰富、平衡、富有表现力与层次感的音乐体验。评价编曲的子维度暂定为：协调性、层次感、创新性。
                      ...
                      <br/><br/>打分细则：
                      <br/><br/>90-100分：
                      乐器音色悦耳，协调性很好，具有层次感，有一定创新性，有感染力；
                      <br/><br/>80-89分：
                      乐器音色悦耳，协调性较好，具有层次感；85-89分还需具有一定创新性；
                      <br/><br/>70-79分：
                      乐器音色比较悦耳，满足基本协调性，略有层次感，不具有创新性；
                      <br/><br/>60-69分：
                      乐器音色不够悦耳，满足基本协调性，单调，不具有层次感；
                      <br/><br/>59分以下：
                      乐器音色不悦耳，不协调，缺乏层次感；
                    </div>
              ...
              <el-form ref="form" label-width="70px" style="margin-top: 50px;" :inline="true"
                ...
                <div class="form-container">
                  <el-tooltip placement="left" effect="customized">
                    <div slot="content" style="font-size: 15px; width: 800px; max-width: 300px;">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;音频质量维度涉及到音乐作品的录音和混音质量。评价音频质量的主要子维度为：杂音干扰、清晰度、平衡性、立体感。
                      <br/>（1）杂音干扰：音频是否干净，没有杂音干扰；（除live版的掌声、欢呼声、尖叫声等）
                      <br/>（2）清晰度：音乐中的各声音元素是否清晰，能被准确、清楚地听到；
                      <br/>（3）平衡性：人声和伴奏音量是否平衡，高中低音频的分布是否均衡协调，各声部之间是否融合；
                      <br/>（4）立体感：旨在考察各乐器的空间位置是否有层次，左右声道的定位是否合理

                      <br/><br/>打分细则：
                      <br/><br/>90-100分：
                      没有杂音干扰，清晰度很好，平衡性很好，具有丰富的立体感；
                      <br/><br/>80-89分：
                      没有杂音干扰，清晰度较好，平衡性较好，具有一定立体感；
                      <br/><br/>70-79分：
                      没有杂音干扰，满足基本清晰度与平衡性，立体感较差；
                      <br/><br/>60-69分：
                      有一些杂音干扰；或清晰度与平衡性较差，立体感差；
                      <br/><br/>59分以下：
                      有持续杂音干扰；或清晰度与平衡性差；
                    </div>
...
export default {
  ...
  data() {
    return {
      ...
      pageLevels: [
        [
          { title: 'S级别', songs: [{ artist: '周杰伦', name: '最长的电影', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}, 
            { artist: '刘德华', name: '17岁', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}] },
          { title: 'A级别', songs: [{ artist: '周杰伦', name: '超人不会飞', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}, 
            { artist: '丁世光', name: '神探', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}] },
          { title: 'B级别', songs: [{ artist: '周杰伦', name: '兰亭序', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}, 
            { artist: '周杰伦', name: '最长的电影', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}, 
            { artist: '刘德华', name: '17岁', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}] },
          { title: 'C级别', songs: [{ artist: '周杰伦', name: '最长的电影', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}, 
            { artist: '刘德华', name: '17岁', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}] },
          { title: 'D级别', songs: [{ artist: '周杰伦', name: '最长的电影', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}, 
            { artist: '刘德华', name: '17岁', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}] }
        ],
        [
          { title: 'S级别', songs: [{ artist: '周杰伦', name: '最长的电影', tip:'1.音色悦耳有特色；声乐演唱技巧控制感很强；2.演唱有戏剧性，有很强的感染力；3.爵士风格节奏中演唱吐字清晰'}, 
...
.audio-description {
  display: block;
  width: 300px; /* 和音频控件保持一致 */
  box-sizing: border-box; /* 包含 padding 在 width 中 */
  margin: 0 auto; /* 自动左右居中 */
  font-size: 14px; /* 根据需要调整字体大小 */
  padding-left: 7px; /* 左边留出空隙 */
  padding-right: 7px; 
  color: #333; /* 文本颜色 */
}
